...
@Component
@Qualifier("hub")
public class DeviceRemovedEventAvroHandler extends BaseEventAvroHandler<DeviceRemovedEventAvro,DeviceRemovedEvent> {
    public DeviceRemovedEventAvroHandler(KafkaEventProducerAvro producer){
        super(producer);
    }
